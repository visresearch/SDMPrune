...
class PackedDataset(Dataset):
    def __init__(
        ...
        if cache:
            ...
            for i in tqdm(range(size)):
                ...
                input_length = torch.sum(torch.tensor(data_point["attention_mask"])).item()
                n_data_point = {}
    ...
    def save(self, path):
        dict = {"max_length": self.max_input_length,
    ...
    def load(self, path):
        ...
        self.max_input_length = dict_json['max_length']
        self.pack_length = dict_json["pack_length"]
        self.groups = dict_json["groups"]
        self.data_points = dict_json["data_points"]
        self.lengths = dict_json["lengths"]
    def stat(self):
        print(
